    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800 mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-2 text-xs space-y-1.5 text-slate-300">
              ...
              <p className="flex items-center gap-2">
                ...
                <span>+91 97903 82437 (முருகேசன் கே EFADGL0636)</span>
              </p>
              <p className="flex items-center gap-2">
        ...
        <div className="mt-10 p-4 bg-slate-950/60 rounded-xl border border-slate-800 text-[11px] text-slate-400 leading-relaxed">
          ...
          <p>
            {language === 'ta'
              ? 'இந்த இணையதளம் பெரியாக்கோட்டை கிராம மக்கள் அரசு திட்டங்கள் மற்றும் சான்றிதழ் விவரங்களை எளிதில் அறிந்துகொள்ளவும், நால்ரோடு மக்கள் இ-சேவை மையத்தின் (முருகேசன் கே) உதவியைப் பெறவும் உருவாக்கப்பட்ட குடிமக்கள் வழிகாட்டி தளம் ஆகும். இது தமிழ்நாடு அரசோ அல்லது மத்திய அரசோ நேரடியாக நடத்தும் தளம் அல்ல. அரசு சான்றிதழ்கள், மானியங்கள் மற்றும் திட்டங்களுக்கான இறுதி ஒப்புதல் மற்றும் தகுதி நிர்ணயம் சம்பந்தப்பட்ட அரசு அலுவலர்களின் ஆய்வுக்கு உட்பட்டது.'
