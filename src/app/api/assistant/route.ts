...
export async function POST(request: Request) {
  try {
    ...
    const fallbackAnswer = language === 'ta'
      ? 'மன்னிக்கவும், உங்கள் கேள்விக்கான சரியான அரசு வழிகாட்டுதல் தரவுத்தளத்தில் நேரடியாக கிடைக்கவில்லை.\n\nதயவுசெய்து நால்ரோடு மக்கள் இ-சேவை மைய ஆபரேட்டர் **முருகேசன்** அவர்களை **97903 82437** என்ற எண்ணில் நேரடியாக தொடர்பு கொள்ளவும். அவர் உங்களுக்கு வழிகாட்டுவார்.'
